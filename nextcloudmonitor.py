...
class NextcloudMonitor():
    ...
    def __init__(self, nextcloud_url, user, app_password):
        self.data = dict()
        self.api_url = f"{nextcloud_url}/ocs/v2.php/apps/serverinfo/api/v1/info?format=json"
        self.user = user
    ...
    def update(self):
        ...
        try:
            ...
            raise BaseException("Connection to Nextcloud API failed. Check your url, username and password and try again")
